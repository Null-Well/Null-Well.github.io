...
export class ProductsComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.productionProds = [
      {
        name: "Kannada Picture Puzzle",
        desc: "This addictive game is simple to play but hard to put down. Each level shows you a picture, and your goal is to guess the hidden Kannada word. It could be anything from a common object to a famous person or a place.",
        logoURL: null,
        prodURLWeb: null,
        prodURLAndroid: 'https://play.google.com/store/apps/details?id=com.sharath.fourpiconeword',
        prodURLWindows: null,
        license: null,
        font: 'Cairo',
      },
